...
<div class="wcgsc-fields">
  <a class="wcgsc-list-set" data-id="1" href="#0">
    ...
    <h2>
      <span class="title1"><?php echo esc_html__( 'Google Sheet to WooCommerce Sync Configuration', 'wc-gsheetconnector' ); ?></span>
    ...
    <div class="sheet-details">
      <h3 class="systemifo">
        ...
        <span class="tooltip-set">
          <i class="wcgsc-helop-icon fa fa-question-circle"></i>
          <span class="tooltiptext-set tooltip-right-set">
            <?php echo esc_html__( "Connected WooCommerce Google Sheet, you'll see the linked sheet. Please note that sheet settings cannot be updated from this interface.", 'wc-gsheetconnector' ); ?>
          </span>
        </span>
      </h3>
...
<div class="system-debug-logs">
  <a class="wcgsc-list-set" data-id="2" href="#0">
    ...
    <h2>
      <span class="title1"><i class="fa fa-refresh" aria-hidden="true"></i> <?php echo esc_html__( 'Sync Settings for Two-Way Sync - Insert & Updates', 'wc-gsheetconnector' ); ?></span>
      <span class="pro-ver"><?php echo esc_html__( 'PRO', 'wc-gsheetconnector' ); ?></span>
      <span class="loading-sign-deactive">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    </h2>
  </a>
  ...
  <div class="wcgsc-list-set2 wcgsc-list-sync">
    <div class="sheet-details">
      ...
      <ol class="wcgsc-gs-alert-steps">
        ...
        <li><?php echo wp_kses_post( __( 'Please refer to the knowledgebase/docs for a comprehensive <a href="https://support.gsheetconnector.com/kb/woocommerce-gsheetconnector-2-way-sync-products" target="_blank">list of supported fields available for two-way synchronization.</a>', 'wc-gsheetconnector' ) ); ?></li>
      </ol>
